      ...
      <section className="relative h-[75vh] min-h-[520px] flex items-end overflow-hidden">
        ...
        <div className="relative w-full max-w-7xl mx-auto px-6 md:px-12 pb-16">
          ...
          >
            ...
            <p className="text-white/55 text-lg max-w-xl">{project.subtitle}</p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { Icon: Settings, label: "System Type", value: project.systemType },
              { Icon: Calendar, label: "Completed", value: project.date },
              ...
              <div key={label} className="flex items-start gap-3">
                ...
                <div>
                  <span className="block text-white/35 text-[10px] tracking-[0.18em] uppercase mb-0.5">
                    {label}
                  </span>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2 space-y-14">
            ...
            >
              ...
              <p className="text-white/50 text-base leading-relaxed">{project.challenges}</p>
            </motion.div>
            ...
            <div className="sticky top-32">
              ...
              >
                ...
                <p className="text-white/45 text-sm leading-relaxed mb-6">
                  Our engineers will design a custom system tailored to your specific location, consumption, and budget.
                </p>
                <Link
                  to="/contact"
                ...
                <Link
                  to="/contact"
                  className="group flex items-center justify-center gap-2 border border-white/10 hover:border-white/20 text-white/60 hover:text-white font-semibold text-sm px-6 py-3.5 rounded-full w-full mt-3 transition-all duration-300"
                >
                  Talk to an Engineer
                </Link>
              </motion.div>
              ...
              >
                <h4 className="text-white/40 text-[10px] tracking-[0.2em] uppercase font-semibold mb-4">
                ...
                <dl className="space-y-4">
                  {[
                    ...
                    { label: "System Capacity", value: project.capacity },
                    ...
                    <div key={label} className="flex justify-between items-center py-2.5 border-b border-white/5 last:border-0">
                      ...
                      <dd className="text-white/80 text-xs font-semibold text-right max-w-[55%]">
                        {value}
                      </dd>
                    </div>
                  ))}
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-black text-white mb-5">
            Ready to Start Your <span className="text-gradient">Solar Journey?</span>
          </h2>
          <p className="text-white/45 text-base mb-8 leading-relaxed">
            Contact us today for a free site assessment and custom proposal — no obligation.
          </p>
          <Link
            to="/contact"
